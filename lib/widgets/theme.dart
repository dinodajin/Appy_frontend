...
class AppColors {
  ...
  static const Color textHigh = Color(0xff313131);
  static const Color textMedium = Color(0xff676767);
...
class IconSize {
  // 아이콘 스타일
  static const double large = 60.0; // 수집함 아이콘
  static const double medium = 30.0; // 앱바 아이콘
  static const double small = 24.0; //설정창 아이콘
}
